...
import { Mail, Phone, Plus, ShieldCheck, Tag, Trash2, Truck, UserCheck } from 'lucide-react';
        ...
        () => [
            {
                header: (
                    <div className="flex items-center gap-2">
                        <Truck size={14} className="text-text-desc" />
                        <span>Vendor / Institusi</span>
                    </div>
                ),
                accessorKey: 'name',
                sortable: true,
            ...
            },
            {
                header: (
                    <div className="flex items-center gap-2">
                        <Tag size={14} className="text-text-desc" />
            ...
            },
            {
                header: (
                    <div className="flex items-center gap-2">
                        <UserCheck size={14} className="text-text-desc" />
                        <span>Representatif / PIC</span>
                    </div>
                ),
