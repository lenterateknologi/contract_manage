...
import { CheckCircle2, Copy, GitBranch, Layers, Plus, ShieldCheck, Trash2, UserCircle } from 'lucide-react';
        ...
        () => [
            {
                header: (
                    <div className="flex items-center gap-2">
                        ...
                        <span>Identitas Alur</span>
                    </div>
                ),
                accessorKey: 'name',
                sortable: true,
                cell: (row: any) => <WorkflowNameCell row={row} />,
            },
            {
                header: (
                    <div className="flex items-center gap-2">
                        <ShieldCheck size={14} className="text-text-desc" />
                        <span>Otoritas Inisiasi</span>
                    </div>
                ),
                accessorKey: 'initiator_type',
                cell: (row: any) => <InitiatorCell row={row} />,
            },
            {
                header: (
                    <div className="flex items-center gap-2">
                        <Layers size={14} className="text-text-desc" />
                        <span>Struktur Tahapan</span>
                    </div>
                ),
                accessorKey: 'steps_count',
                cell: (row: any) => <StepsCell row={row} />,
            },
        ],
        [],
    );
