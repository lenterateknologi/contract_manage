        ...
        <div className="animate-in fade-in slide-in-from-left-4 h-full space-y-4 duration-300">
            ...
            <div className="group/json relative">
                <textarea
                    ...
                    className={cn(
                        'focus:ring-primary/20 bg-muted/20 text-foreground min-h-[500px] w-full rounded-2xl border-none p-6 font-mono text-[10px] leading-relaxed transition-all focus:ring-2',
