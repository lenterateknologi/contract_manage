        ...
        return (
            <div className="animate-in fade-in slide-in-from-right-4 space-y-6">
                <div className="bg-primary/10 flex items-center gap-3 rounded-xl p-4">
                    ...
                    <div>
                        <h3 className="text-[10px] font-black tracking-widest uppercase">Konfigurasi Halaman</h3>
                ...
                <div className="border-border space-y-4 border-t pt-6">
                    <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-[9px] font-black tracking-widest uppercase">Margin Dokumen (mm)</h4>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Margin Atas</Label>
                            <Input
                                type="number"
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Margin Bawah</Label>
                            <Input
                                type="number"
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Margin Kiri</Label>
                            <Input
                                type="number"
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Margin Kanan</Label>
                            <Input
                                type="number"
                            ...
                            {['image', 'f1_header'].includes(selectedField.type) && (
                                <div className="border-border space-y-4 border-t pt-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-[9px] font-black tracking-widest uppercase">
                                            Image & Branding
                                        </h4>
                                    </div>
                            ...
                            {['group', 'grid_x', 'grid_y', 'static_text'].includes(selectedField.type) && (
                                <div className="border-border space-y-4 border-t pt-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-[9px] font-black tracking-widest uppercase">Borders & Style</h4>
                                    </div>

                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Border Style</Label>
                                            <select
                                                ...
                                                className="border-input bg-background h-8 w-full rounded-md border px-2 text-[10px] font-bold"
                                            >
                                                <option value="none">None</option>
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-muted-foreground text-[8px] font-bold uppercase">Border Width (px)</Label>
                                            <Input
                                                type="number"
