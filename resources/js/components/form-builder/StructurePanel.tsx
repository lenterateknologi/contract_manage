...
import { ChevronDown, FileText, Layout, Search, X, Trash2 } from 'lucide-react';
                ...
                >
                    ...
                    {onRemoveField && (
                        <button
                            ...
                            className="text-muted-foreground/40 hover:text-destructive opacity-0 group-hover:opacity-100 transition-opacity p-0.5 rounded"
                        >
                            <Trash2 size={10} />
                        </button>
                    )}
                ...
                <div className="flex items-center gap-2">
                    ...
                    {onRemoveSelected && selectedFieldIds.length > 0 && (
                        <button
                            ...
                            className="bg-primary/5 hover:bg-primary/10 text-primary flex flex-1 items-center justify-center gap-1.5 rounded-lg py-1.5 text-[8px] font-black uppercase transition-all ring-1 ring-primary/20"
                        >
