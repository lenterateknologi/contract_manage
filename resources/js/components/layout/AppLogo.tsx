    ...
    return (
        <div className="flex items-center gap-2.5 px-1">
            <div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg shadow-sm">
                <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-5 fill-current">
            ...
            <div className="flex flex-col">
                <span className="text-sidebar-foreground text-[13.5px] leading-none font-bold tracking-tight">Contract</span>
                <span className="text-sidebar-foreground/40 mt-0.5 text-[10px] leading-none font-medium tracking-[0.05em]">Management</span>
            </div>
        </div>
    );
}
