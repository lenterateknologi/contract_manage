    ...
    return (
        ...
        >
            <div className="flex items-start justify-between">
                ...
                <span className="text-text-desc text-[9px] font-bold tracking-wider uppercase">{subtext}</span>
            </div>
            <div>
                <p className="text-text-desc mb-0.5 text-[10px] font-bold tracking-wider uppercase">{label}</p>
