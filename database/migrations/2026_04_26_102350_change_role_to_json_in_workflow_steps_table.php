...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (config('database.default') === 'pgsql') {
            ...
            try {
                \Illuminate\Support\Facades\DB::statement('DROP INDEX IF EXISTS m_workflow_steps_role_index');
            } catch (\Exception $e) {}
            
            \Illuminate\Support\Facades\DB::statement('ALTER TABLE m_workflow_steps ALTER COLUMN role TYPE json USING json_build_array(role)');
        } else {
