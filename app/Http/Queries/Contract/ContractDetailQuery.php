...
class ContractDetailQuery
{
     ...
     */
    private const WITH = [
        'creator:id,name,role,role_id,department_id,division_id,company_id,email',
        ...
        'approvals.approver:id,name,role,role_id,department_id,division_id,company_id,email',
        ...
        'versions.uploader:id,name,role,role_id,department_id,division_id,company_id,email',
        'histories.actor:id,name,role,role_id,department_id,division_id,company_id,email',
        'messages.user:id,name,role,role_id,department_id,division_id,company_id,email',
        'attachments.uploader:id,name,role,role_id,department_id,division_id,company_id,email',
        'formSubmissions:id,contract_id,document_type,form_template_id,current_version,submitted_by,updated_at',
        'formSubmissions.submittedBy:id,name,role,role_id,department_id,division_id,company_id,email',
        'vendor:id,name,pic_name,pic_position,address',
        'vendor.documents:id,vendor_id,document_name,document_type',
        'initiator:id,name,role,role_id,department_id,division_id,company_id,email',
        'initiator.department:id,name',
        'initiator.company:id,name,company_group_id,region_id',
        'assignedPic:id,name,role,role_id,department_id,division_id,company_id,email',
        'assignedPic.department:id,name',
        'assignedBy:id,name,role,role_id,department_id,division_id,company_id,email',
