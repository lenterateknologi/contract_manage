...
class ContractController extends Controller
{
    ...
    private function getDashboardMetrics(Request $request)
    {
        ...
        $submissionTypeCounts = DB::table('t_contracts')
        ...
        $contractTypeCounts = DB::table('t_contracts')
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $monthlyTrend->push([
                ...
                'value' => $contractsInMonth->sum(fn ($c) => $this->parsePrice($c->meta?->f2_price)),
            ]);
        }
        ...
        $topVendors = (clone $baseQuery)
            ...
            ->map(function ($group) {
                ...
                return [
                    ...
                    'count' => $group->count(),
                    'value' => $group->sum(fn ($c) => $this->parsePrice($c->meta?->f2_price)),
                ];
            })
            ->sortByDesc('value')
            ->take(5)
