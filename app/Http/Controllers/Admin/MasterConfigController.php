...
class MasterConfigController extends Controller
{
    ...
    public function contractTypes(Request $request): Response
    {
        ...
        return Inertia::render('admin/Index', [
            ...
            'types' => $query->orderBy($sortBy, $sortDir)->paginate($request->input('per_page', 25))->withQueryString(),
    ...
    public function contractStatuses(Request $request)
    {
        ...
        return Inertia::render('admin/Index', [
            ...
            'statuses' => $query->orderBy('label')->paginate($request->input('per_page', 25))->withQueryString(),
    ...
    public function departments(Request $request)
    {
        ...
        return Inertia::render('admin/Index', [
            ...
            'departments' => $query->orderBy('name')->paginate($request->input('per_page', 25))->withQueryString(),
    ...
    public function moduleGroups(Request $request)
    {
        ...
        return Inertia::render('admin/Index', [
            ...
            'moduleGroups' => $query->orderBy('name')->paginate($request->input('per_page', 25))->withQueryString(),
            'filters' => $request->only(['search']),
    ...
    public function modules(Request $request)
    {
        ...
        return Inertia::render('admin/Index', [
            'currentView' => 'modules',
            'modules' => $query->orderBy('name')->paginate($request->input('per_page', 25))->withQueryString(),
