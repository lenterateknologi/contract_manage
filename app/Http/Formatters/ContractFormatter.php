...
class ContractFormatter
{
    public static function formatContract(Contract $c, bool $isDetail = true): array
    {
        ...
        return [
            ...
            'f1_mode' => self::getEffectiveMode($c, 'f1', ($c->contractType?->f1_input_mechanism === 'manual') ? 'interactive' : 'upload'),
            'f1_form_template_id' => $c->contractType?->f1_form_template_id,
            'f2_mode' => self::getEffectiveMode($c, 'f2', ($c->contractType?->f2_input_mechanism === 'manual') ? 'interactive' : 'upload'),
