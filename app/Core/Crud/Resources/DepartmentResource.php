...
class DepartmentResource extends Resource
{
    ...
    public static function form(): array
    {
        return [
            ...
            TextInput::make('org_group_name', 'Group Organisasi')
                ->rules(['nullable', 'string', 'max:255']),
            TextInput::make('org_level_name', 'Level Organisasi')
    ...
    public static function filters(): array
    {
        return [
            ...
            Filter::make('org_level_name', 'Level Organisasi')
                ->options(fn () => Department::whereNotNull('org_level_name')->distinct()->pluck('org_level_name', 'org_level_name')->toArray()),
            Filter::make('org_group_name', 'Group Organisasi')
                ->options(fn () => Department::whereNotNull('org_group_name')->distinct()->pluck('org_group_name', 'org_group_name')->toArray()),
        ];
    }
}
